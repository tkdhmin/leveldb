...
# -----------~-----------------------------------------------------
write_buffer_size_list="2097152 4194304 8388608 16777216 33554432"
max_file_size_list="2097152 4194304 8388608 16777216 33554432"
for i in $write_buffer_size_list
do
        for j in $max_file_size_list
        do
